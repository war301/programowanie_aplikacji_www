...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "DELETE FROM obiekty_do_sklepu WHERE id = ?";
...
<body>
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5 mb-3">Usuwanie Przedmiotu</h2>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            <input type="hidden" name="id" value="<?php echo trim($_GET["id"]); ?>"/>
                            <p>Chcesz usunąć dany przedmiot?</p>
                            <p>
                                <input type="submit" value="Tak" class="btn btn-danger">
                                <a href="produkty_read.php" class="btn btn-secondary">Nie</a>
                            </p>
                        </div>
                    </form>
                </div>
